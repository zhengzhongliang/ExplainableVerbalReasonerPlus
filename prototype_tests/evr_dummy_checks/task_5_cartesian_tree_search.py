...
class NeuralModule:
    ...
    def inference(self, textual_input):
        ...
        if textual_input.startswith("generate_program: "):
            ...
            program_text = ""
            if len(re.findall(r'episodic_buffer_0:\s+this is a cartesian tree search task', textual_input)) > 0 and \
                ...
                len(re.findall(r'episodic_buffer_2:\s+did john doe have 4 puppies', textual_input)) > 0:
            ...
            if len(re.findall(r'episodic_buffer_0:\s+this is a cartesian task', textual_input)) > 0 and \
                ...
                program_text = \
                    ...
                    "return('it is converted to a tree search task'); "

            if len(re.findall(r'episodic_buffer_0:\s+this is a cartesian tree search task', textual_input)) > 0 and \
                len(re.findall(r'episodic_buffer_1:\s+chunk 0 can be used to infer the number of items each person had', textual_input)) > 0 and \
                len(re.findall(r'episodic_buffer_2:\s+did john doe have 4 puppies', textual_input)) > 0 and \
                len(re.findall(r'episodic_buffer_3:\s+it is converted to a tree search task', textual_input)) > 0:
        ...
        if textual_input.startswith("clear_mem: "):
            ...
            return_var = \
                ...
                "episodic_buffer_1: 'Did John Doe have 4 puppies?' "
...
class CheckCartesianTreeSearch:
    ...
    def check_chaining_tree_search_integrated(cls):
        ...
        episodic_buffer_dict = {
            ...
            "episodic_buffer_2": "Did John Doe have 4 puppies? ",
        }
        ...
        prog_int.new_mem_handler(
            program_lines_parent_level=[
                "new_mem(episodic_buffer_0, episodic_buffer_1, episodic_buffer_2)"],
